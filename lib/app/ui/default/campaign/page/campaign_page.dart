...
class CampaignPage extends GetView<CampaignController> {
  ...
  void loadGroupData(String campaignKey) {
    Get.find<GroupController>().getGroupListData(campaignKey);
          ...
          builder: (_) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final String campaignName = campaignData.name as String;
